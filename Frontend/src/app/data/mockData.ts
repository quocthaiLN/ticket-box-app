...
export interface RequestTicketType {
  zoneCode: string;
  zoneName: string;
  zoneCapacity: number;
  name: string;
...
export interface ConcertDeletionRequest {
  id: string;
  concertId: string;
  concertTitle: string;
  organizerId: string;
...
export const USERS: User[] = [
  { id: "user-admin-1", email: "admin@ticketbox.test", fullName: "Demo Admin", role: "ADMIN", phone: "+84900000004", status: "ACTIVE", createdAt: "2026-01-01T00:00:00" },
  { id: "user-organizer-1", email: "organizer@ticketbox.test", fullName: "Demo Organizer", role: "ORGANIZER", phone: "+84900000002", status: "ACTIVE", createdAt: "2026-01-05T00:00:00" },
  { id: "user-checker-1", email: "checker@ticketbox.test", fullName: "Demo Checker", role: "CHECKER", phone: "+84900000003", status: "ACTIVE", createdAt: "2026-01-10T00:00:00" },
  { id: "user-audience-1", email: "audience@ticketbox.test", fullName: "Demo Audience", role: "AUDIENCE", phone: "+84900000001", status: "ACTIVE", createdAt: "2026-02-01T00:00:00" },
  { id: "user-audience-2", email: "nguyen.van.a@gmail.com", fullName: "Nguyễn Văn A", role: "AUDIENCE", phone: "+84901234567", status: "ACTIVE", createdAt: "2026-03-15T00:00:00" },
  { id: "user-organizer-2", email: "organizer2@events.vn", fullName: "Cty Sự Kiện XYZ", role: "ORGANIZER", phone: "+84912345678", status: "SUSPENDED", createdAt: "2026-04-01T00:00:00" },
];
...
export const ORGANIZER_REQUESTS: OrganizerRequest[] = [
  {
    ...
    organizerEmail: "organizer@ticketbox.test",
    venueId: "venue-3",
    title: "Saigon Indie Weekend",
    artistName: "Indie Collective",
    description: "A weekend festival featuring the best indie acts from Vietnam and Southeast Asia.",
    startsAt: "2027-01-18T19:00:00",
    endsAt: "2027-01-18T22:30:00",
    plannedPublishAt: "2026-12-05T10:00:00",
    gateCount: 2,
    checkerCount: 3,
    pressKitUrl: "/press-kit/saigon-indie-weekend.pdf",
    ticketTypes: [
      { zoneCode: "VIP", zoneName: "VIP", zoneCapacity: 500, name: "VIP", price: 1500000, totalQuantity: 500, maxPerUser: 2, saleStartAt: "2026-12-10T10:00:00", saleEndAt: "2027-01-18T12:00:00" },
      { zoneCode: "GA", zoneName: "General Admission", zoneCapacity: 2500, name: "GA", price: 650000, totalQuantity: 2500, maxPerUser: 4, saleStartAt: "2026-12-10T10:00:00", saleEndAt: "2027-01-18T12:00:00" },
    ],
    status: "PENDING",
  ...
  },
  {
    ...
    startsAt: "2026-12-31T20:00:00",
    endsAt: "2026-12-31T23:59:00",
    plannedPublishAt: "2026-12-01T10:00:00",
    gateCount: 2,
    checkerCount: 2,
    pressKitUrl: "/press-kit/secret-show-2026.pdf",
    ticketTypes: [
      { zoneCode: "VIP", zoneName: "VIP Secret Circle", zoneCapacity: 120, name: "VIP Secret Circle", price: 1800000, totalQuantity: 120, maxPerUser: 2, saleStartAt: "2026-12-01T10:00:00", saleEndAt: "2026-12-31T12:00:00" },
      { zoneCode: "GA", zoneName: "General Admission", zoneCapacity: 1200, name: "GA", price: 700000, totalQuantity: 1200, maxPerUser: 4, saleStartAt: "2026-12-01T10:00:00", saleEndAt: "2026-12-31T12:00:00" },
    ],
    status: "APPROVED",
    reviewedById: "user-admin-1",
    reviewedAt: "2026-06-12T14:00:00",
  ...
  },
  {
    ...
    startsAt: "2027-02-12T19:30:00",
    endsAt: "2027-02-12T22:00:00",
    plannedPublishAt: "2027-01-05T10:00:00",
    gateCount: 1,
    checkerCount: 1,
    pressKitUrl: "/press-kit/midnight-acoustic-archive.pdf",
    ticketTypes: [
      { zoneCode: "CAT1", zoneName: "CAT 1", zoneCapacity: 300, name: "CAT 1", price: 900000, totalQuantity: 300, maxPerUser: 2, saleStartAt: "2027-01-10T10:00:00", saleEndAt: "2027-02-12T12:00:00" },
    ],
    status: "REJECTED",
    reviewedById: "user-admin-1",
    reviewedAt: "2026-06-15T09:30:00",
    reviewNote: "Venue hold document is missing. Please resubmit with complete documentation.",
...
export const DELETION_REQUESTS: ConcertDeletionRequest[] = [
  {
    id: "del-001",
    concertId: "concert-5",
    concertTitle: "Nơi Tình Yêu Bắt Đầu",
    organizerId: "user-organizer-1",
    organizerName: "Demo Organizer",
    reason: "Organizer needs to move the show to a larger venue due to high demand.",
    status: "PENDING",
  ...
  },
  {
    id: "del-002",
    concertId: "concert-4",
    concertTitle: "Một Thời Đã Yêu",
    organizerId: "user-organizer-1",
    organizerName: "Demo Organizer",
    reason: "Duplicate request submitted during schedule review.",
    status: "REJECTED",
    reviewedById: "user-admin-1",
    reviewedAt: "2026-06-16T15:15:00",
...
export const ORGANIZER_STATS = {
  myConcerts: 6,
  publishedConcerts: 5,
  totalRevenue: 6_240_000_000,
  ticketsSold: 21_888,
  pendingRequests: 1,
  monthlyRevenue: [
    { month: "T4", revenue: 480_000_000 },
    { month: "T5", revenue: 720_000_000 },
    { month: "T6", revenue: 1_100_000_000 },
    { month: "T7", revenue: 1_650_000_000 },
    { month: "T8", revenue: 1_280_000_000 },
    { month: "T9", revenue: 1_010_000_000 },
  ],
  topConcerts: [
    { title: "Đi Qua Thương Nhớ Live Concert", revenue: 2_850_000_000, sold: 12_250, total: 35_500 },
    { title: "Our 20th Moment 2026", revenue: 1_920_000_000, sold: 5_937, total: 8_500 },
    { title: "Ánh Sáng Màn Đêm", revenue: 890_000_000, sold: 1_789, total: 3_200 },
  ],
};
