...
-- CreateEnum
CREATE TYPE "notification_type" AS ENUM ('SYSTEM', 'ORDER_CONFIRMED', 'PAYMENT_FAILED', 'TICKET_ISSUED', 'CONCERT_UPDATED', 'CONCERT_REMINDER', 'CHECKIN_ALERT', 'ARTIST_BIO_READY');
