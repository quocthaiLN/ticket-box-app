...
WITH zone_seed(id, concert_id, code, name, description, capacity, svg_path, sort_order) AS (
  VALUES
    ('00000000-0000-0000-0000-000000000301'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'SVIP', 'SVIP', 'Khu gần sân khấu.', 200, 'M120 10 H180 V70 H120 Z', 1),
    ('00000000-0000-0000-0000-000000000302'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'VIP', 'VIP', 'Khu ưu tiên.', 1800, 'M190 10 H260 V90 H190 Z', 2),
    ('00000000-0000-0000-0000-000000000303'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'CAT1', 'CAT1', 'Khu ghế trung tâm.', 6000, 'M270 10 H360 V130 H270 Z', 3),
    ('00000000-0000-0000-0000-000000000304'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'CAT2', 'CAT2', 'Khu ghế phổ thông.', 10000, 'M370 10 H480 V160 H370 Z', 4),
    ('00000000-0000-0000-0000-000000000305'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'GA', 'General Admission', 'Khu đứng tự do.', 14000, 'M10 10 H110 V110 H10 Z', 5),
