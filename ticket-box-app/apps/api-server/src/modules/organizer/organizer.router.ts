...
organizerRouter.post(
  "/organizer/concerts/:concert_id/ticket-types",
...
organizerRouter.get(
  "/organizer/concerts/:concert_id/guests",
...
organizerRouter.get(
  ...
  controller.getTicketTypeInventory,
);
organizerRouter.get(
  "/organizer/checker-accounts",
  controller.listCheckerAccounts,
);
