...
export function AdminConcertForm() {
  ...
  const handleSave = () => {
    setSaved(true);
    setTimeout(() => { setSaved(false); navigate("/admin/concerts"); }, 1500);
  };
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        <button onClick={() => navigate("/admin/concerts")} className="p-2 rounded-lg transition-colors hover:bg-white/5" style={{ color: "#F0EDEB" }}>
