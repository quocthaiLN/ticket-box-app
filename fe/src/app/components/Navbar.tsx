              ...
              <div className="relative">
                ...
                {profileOpen && (
                  ...
                  >
                    ...
                    {isAdmin && (
                      <DropdownItem icon={<LayoutDashboard className="w-4 h-4" />} label="Quản trị" to="/admin" onClick={() => setProfileOpen(false)} />
                    )}
                    <button
        ...
        >
          ...
          {user ? (
            <>
              ...
              {isAdmin && <MobileNavLink to="/admin" label="Quản trị" onClick={() => setMenuOpen(false)} />}
              <button
